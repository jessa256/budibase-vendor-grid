...
import json from "@rollup/plugin-json"  // Updated import
...
const ignoredWarnings = [
  ...
  "a11y-no-onchange",
  "a11y-click-events-have-key-events",  // Added for simplified component
  "a11y-no-static-element-interactions", // Added for simplified component
]
...
export default {
  ...
  plugins: [
    ...
    svelte({
      emitCss: true,
      compilerOptions: {
        dev: process.env.ROLLUP_WATCH ? true : false,  // Enable dev mode for watch
      },
    ...
    postcss({
      extract: false,  // Inline CSS for component simplicity
